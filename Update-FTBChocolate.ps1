...
if (Test-Path "$env:LOCALAPPDATA\.ftba\Instances") {
    Get-ChildItem -Path "$env:LOCALAPPDATA\.ftba\Instances" -Directory | ForEach-Object {
        if ((Get-Content -Path $_\instance.json) -like "*FTB Chocolate*") {
            $global:InstancePath = "$env:LOCALAPPDATA\.ftba\Instances\$_"
...
Invoke-WebRequest -Uri "https://github.com/chazza6464/Modpacks/blob/main/Mod%20Files/create-1.18.2-0.5.0.e.jar" -OutFile "$global:InstancePath\Mods\create-1.18.2-0.5.0.e.jar"
...
Invoke-WebRequest -Uri "https://github.com/chazza6464/Modpacks/blob/main/Mod%20Files/flywheel-forge-1.18.2-0.6.5.jar" -OutFile "$global:InstancePath\Mods\flywheel-forge-1.18.2-0.6.5.jar"
...
# OpenBlocks Elevator
# Install 1.8.4
Invoke-WebRequest -Uri "https://github.com/chazza6464/Modpacks/blob/main/Mod%20Files/elevatorid-1.18.2-1.8.4.jar" -OutFile "$global:InstancePath\Mods\elevatorid-1.18.2-1.8.4.jar"
Write-Host "(4/6) Downloaded OpenBlocks Elevator" -ForegroundColor Yellow

# Iron Chests
# Install 13.2.11
Invoke-WebRequest -Uri "https://github.com/chazza6464/Modpacks/blob/main/Mod%20Files/ironchest-1.18.2-13.2.11.jar" -OutFile "$global:InstancePath\Mods\ironchest-1.18.2-13.2.11.jar"
